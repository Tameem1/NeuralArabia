  ...
  const developmentAreas = [
    {
      ...
      description:
        "تطوير نماذج فهم وتحليل اللغة العربية لاستخراج الأفكار والمعلومات بشكل آلي",
    },
    {
      id: "cv",
      title: "رؤية الحاسوب",
      icon: "fas fa-camera",
      description:
        "تحليل ومعالجة الصور والفيديو باستخدام خوارزميات الذكاء الاصطناعي",
    },
    {
      id: "systems",
      title: "أنظمة التوصية",
              ...
              <ul className="space-y-4 mb-8">
                {consultingFeatures.map((feature, index) => (
                  ...
                  >
                    ...
                    <span className="mr-6 ml-6">{feature}</span>
                  </li>
                ))}
              </ul>
              ...
              <ul className="space-y-3 mb-8">
                {developmentFeatures.map((feature, index) => (
                  ...
                  >
                    <div className="flex-shrink-0">
                      <i
                        className={`fas fa-check-circle text-primary text-lg`}
                      ></i>
                    </div>
