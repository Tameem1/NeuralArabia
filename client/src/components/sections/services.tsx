...
export default function Services() {
  ...
  useEffect(() => {
    ...
    const developmentObserver = new IntersectionObserver(
      ([entry]) => {
        if (entry.isIntersecting) {
  ...
  return (
    <>
      ...
      <section id="ai-consulting" className="py-24 bg-gradient-to-b from-white to-accent/20">
        <div className="container mx-auto px-6" ref={consultingSectionRef}>
          <div className={`text-center mb-12 transition-all duration-1000 ${isConsultingVisible ? 'opacity-100' : 'opacity-0 translate-y-10'}`}>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className={`order-2 lg:order-1 transition-all duration-1000 delay-200 ${isConsultingVisible ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-20'}`}>
              <ul className="space-y-4 mb-8">
                {consultingFeatures.map((feature, index) => (
                  ...
                  >
                    ...
                    <span className="mr-0 ml-6">{feature}</span>
                  </li>
                ))}
              </ul>
              
              <div className={`transition-all duration-1000 ${isConsultingVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`} style={{ transitionDelay: '600ms' }}>
                <Button 
      ...
      <section id="ai-development" className="py-24 bg-gradient-to-b from-accent/20 to-white">
        <div className="container mx-auto px-6" ref={developmentSectionRef}>
          <div className={`text-center mb-12 transition-all duration-1000 ${isDevelopmentVisible ? 'opacity-100' : 'opacity-0 translate-y-10'}`}>
            <h2 className="font-cairo font-bold text-3xl md:text-4xl mb-4 text-primary">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className={`order-2 lg:order-1 transition-all duration-1000 delay-200 ${isDevelopmentVisible ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-20'}`}>
              <div className="bg-white rounded-xl p-6 shadow-lg mb-8 glow">
                ...
                <div className="grid grid-cols-3 gap-2 mb-6">
                  {developmentAreas.map((area, index) => (
                    <div 
                      key={area.id}
                      className={`text-center p-3 rounded-lg cursor-pointer transition-all duration-300 ${activeDevTab === index 
